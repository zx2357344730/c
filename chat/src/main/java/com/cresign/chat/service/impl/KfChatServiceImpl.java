...
import com.cresign.chat.service.KfChatService;
...
//                return RetResult.jsonResultEncrypt(HttpStatus.OK, LogEnum.LOG_GET_DATA_NULL.getCode(),"获取订单数据为空");
                ...
                throw new ErrorResponseException(HttpStatus.OK, ChatEnum.ERR_GET_ORDER_NULL.getCode(), "获取订单数据为空");
            }
...
//                return RetResult.jsonResultEncrypt(HttpStatus.OK, LogEnum.LOG_GET_DATA_NULL.getCode(),"获取订单数据为空");
        ...
        // 添加返回数据
        objectMap.put(Constants.ADD_OBJ_DATA,this.getCusmsgLogListByEs(oId, type,indexOnly));
...
//                ,objectMap);
    ...
    public ApiResponse getCompByCompIdAndWsIdAndKf(String id_C,String id_U) {
        ...
        JSONObject userInfo = coupaUtil.getUserInfo(id_U);
        if (null != userInfo) {
...
//                                ,"该公司没有客服!");
                        ...
                        throw new ErrorResponseException(HttpStatus.OK, ChatEnum.ERR_COMP_NO_CUSTOMER_SERVICE.getCode(), "该公司没有客服");
                    }
                    // 抛出操作成功异常
...
//                ,"您的个人信息有误!");
        ...
        throw new ErrorResponseException(HttpStatus.OK, ChatEnum.ERR_INCORRECT_PERSONAL_INFORMATION.getCode(), "您的个人信息有误");
    }
...
//            if (obj.getString(Constants.GET_TYPE).equals("cusmsg")&&obj.getString(Constants.GET_ID).equals(id_O)){
...
//                        return RetResult.jsonResultEncrypt(HttpStatus.OK, LogEnum.LOG_GET_DATA_NULL.getCode(),"es获取数据为空");
                        ...
                        throw new ErrorResponseException(HttpStatus.BAD_REQUEST, ChatEnum.ERR_ES_GET_DATA_IS_NULL.getCode(), "es获取数据为空");
                    }
                    ...
                    LogFlow.setTmd(dateUtils.getDateByT(DateEnum.DATE_TWO.getDate()));
...
//        return RetResult.jsonResultEncrypt(HttpStatus.OK, LogEnum.LOG_GET_DATA_NULL.getCode(),"出现异常");
        ...
        throw new ErrorResponseException(HttpStatus.BAD_REQUEST, ChatEnum.ERR_AN_ERROR_OCCURRED.getCode(), "出现错误");
    }
    ...
    public void sendLog(LogFlow logL){
        ...
        data.put(Constants.ADD_IS_OK,0);
        logL.setData(data);

        // 发送日志
        WebSocketUserServer.sendLog(logL);
    }
