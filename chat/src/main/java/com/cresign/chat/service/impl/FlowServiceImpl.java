...
//    private OrderService orderService;
    ...
    public ApiResponse getDgResult(String id_OParent,String id_U,String myCompId,JSONObject wrdNU,Long teStart) {
            ...
            Map<String, List<OrderAction>> objActionCollection,Map<String, List<OrderOItem>> objOItemCollection)
    {
        ...
        // 递归零件信息设置子零件集合
                ...
                this.dgMergeQtySet(qtyNeed, partArray.getJSONObject(partIndex).getDouble("wn4qtyneed"), 
                        finO,fin_Ind,objActionCollection, objOItemCollection);
...
//                partItem.getJSONObject(item).put("bmdpt",bmdptValue);
     ...
     */
    @Override
    public ApiResponse dgRemove(String id_O,String id_C,String id_U,JSONObject wrdNU) {
