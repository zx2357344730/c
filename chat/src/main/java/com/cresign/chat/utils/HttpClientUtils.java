...
public class HttpClientUtils {
    ...
    public static JSONObject httpPost(String url, String strParam)
    {
        // post请求返回结果
        CloseableHttpClient httpClient = HttpClients.createDefault();
        JSONObject jsonResultEncrypt = null;
        HttpPost httpPost = new HttpPost(url);
        httpPost.setConfig(requestConfig);
        try
        {
            ...
            if (result.getStatusLine().getStatusCode() == HttpStatus.SC_OK)
            {
                ...
                try
                {
                    ...
                    // 把json字符串转换成json对象
                    jsonResultEncrypt = JSONObject.parseObject(str);
                }
                catch (Exception e)
                {
    ...
    public static JSONObject httpGet(String url)
    {
        ...
        try
        {
            ...
            if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK)
            {
                ...
                // 把json字符串转换成json对象
                jsonResultEncrypt = JSONObject.parseObject(strResult);
            }
            else
            {
    ...
    public static String httpPostAndHead(String url, JSONObject jsonParam,JSONObject heads)
    {
        ...
        String resultStr = null;
        HttpPost httpPost = new HttpPost(url);
        Set<String> strings = heads.keySet();
        strings.forEach(s -> httpPost.addHeader(s,heads.getString(s)));
        // 设置请求和传输超时时间
        httpPost.setConfig(requestConfig);
        try
        {
