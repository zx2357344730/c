...
//@Component
//@Sharable
//public class WebSocketLoginServerF {
//
//    @Override
...
//     */
//    private static CopyOnWriteArraySet<WebSocketLoginServerF> webSocketSet;
//
//    /**
//     * 用来存储所有产品的连接
//     */
//    private static final Map<String,CopyOnWriteArraySet<WebSocketLoginServerF>> map = new HashMap<>(16);
//
//    /**
//     * 用来存储所有产品连接的在线人数
//     */
...
//
//        // 根据prodID获取产品连接
//        CopyOnWriteArraySet<WebSocketLoginServerF> writeArraySet = map.get(id);
//        // 获取当前用户session
