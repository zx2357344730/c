...
//
    ...
    public Object cTrigger(@RequestBody JSONObject json) throws ParseException, IOException, ScriptException, ClassNotFoundException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
...
//        SearchResponse searchResponse = restHighLevelClient.search(searchRequest, RequestOptions.DEFAULT);
    ...
    public Object addIndexByYear(@RequestBody JSONObject json) throws IOException {
        ...
        for (Map.Entry<String, Object> entry : jsonMapping.entrySet()) {
            ...
            CreateIndexResponse createIndexResponse = elasticsearchUtils.addIndex(indexName, mapping);
