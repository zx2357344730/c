...
//    }
//
//    public static File statExcel(JSONArray arrayExcel, JSONArray arrayField, String writeName) throws IOException {
//        long one = System.currentTimeMillis();
//        //创建excel文件并命名
//        File excelFile = File.createTempFile(writeName, ".xlsx");
//        FileOutputStream fileOutputStream = new FileOutputStream(excelFile);
...
//            int length = jsonField.getJSONObject("wrdN").getString("cn").getBytes(StandardCharsets.UTF_8).length;
...
//                int length = jsonExcel.getString(jsonField.getString("ref")).getBytes(StandardCharsets.UTF_8).length;
//                if (jsonField.getInteger("length") < length) {
//                    jsonField.put("length", length);
//                }
//            }
//        }
...
//                XSSFCell cell = row.createCell(j);
//                if (i == 0) {
//                    sheet.setColumnWidth(j, jsonField.getInteger("length") * 256 + 200);
//                    cell.setCellStyle(cellTitleStyle);
//                    cell.setCellValue(jsonField.getJSONObject("wrdN").getString("cn"));
//                } else {
//                    String type = jsonField.getString("type");
//                    switch (type) {
//                        case "String":
//                            cell.setCellValue(jsonExcel.getString(jsonField.getString("ref")));
//                            break;
//                        case "Integer":
//                            cell.setCellValue(jsonExcel.getInteger(jsonField.getString("ref")));
//                            break;
//                        case "Double":
//                            cell.setCellValue(jsonExcel.getDouble(jsonField.getString("ref")));
//                            break;
//                    }
//                }
//            }
