...
//    }
//    @Async
//    public Future<String> execThread1(HashSet<String> id_Ps, JSONArray item, String myCompId) {
...
//
//    @Async
//    public Future<String> execThread2(HashSet<String> id_Ps,JSONArray item,String myCompId) {
//        Future<String> future;
//        try {
//            for (int i = 0; i < item.size(); i++) {
//                String id_P = item.getJSONObject(i).getString("id_P");
...
//
//    @Async
//    public Future<String> execThread3(HashSet<String> id_Ps,JSONArray item,String myCompId) {
//        Future<String> future;
//        try {
//            for (int i = 0; i < item.size(); i++) {
//                String id_P = item.getJSONObject(i).getString("id_P");
...
//
//    @Async
//    public Future<String> execThread4(HashSet<String> id_Ps,JSONArray item,String myCompId) {
//        Future<String> future;
//        try {
//            for (int i = 0; i < item.size(); i++) {
//                String id_P = item.getJSONObject(i).getString("id_P");
...
//
//    @Async
//    public Future<String> execThread5(HashSet<String> id_Ps,JSONArray item,String myCompId) {
//        Future<String> future;
//        try {
//            for (int i = 0; i < item.size(); i++) {
//                String id_P = item.getJSONObject(i).getString("id_P");
...
//
//    @Async
//    public Future<String> execThread6(HashSet<String> id_Ps,JSONArray item,String myCompId) {
//        Future<String> future;
//        try {
//            for (int i = 0; i < item.size(); i++) {
//                String id_P = item.getJSONObject(i).getString("id_P");
...
//
//    @Async
//    public Future<String> execThread7(HashSet<String> id_Ps,JSONArray item,String myCompId) {
//        Future<String> future;
//        try {
//            for (int i = 0; i < item.size(); i++) {
//                String id_P = item.getJSONObject(i).getString("id_P");
