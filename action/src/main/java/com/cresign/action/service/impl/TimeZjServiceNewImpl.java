...
//                        ,orderNew.getInfo().getId_OP(),objOrderList,actionIdO,allImageTeDate);
//
...
//                    System.out.println();
                ...
                timeZjServiceComprehensive.taskLastHandle(timeConflictCopy,id_C,randomAll,objTaskAll
                        ,storageTaskWhereTime,allImageTotalTime,allImageTasks,recordNoOperation
                        ,orderNew.getInfo().getId_OP(),objOrderList,actionIdO,allImageTeDate,depAllTime);
...
//                // 获取任务的部门信息
//                JSONObject depInfo = objTask.getJSONObject(dep);
//                // 获取删除操作的部门信息
//                JSONArray delGrpBList = del.getJSONArray(dep);
//                // 遍历删除操作部门信息
//                for (int i = 0; i < delGrpBList.size(); i++) {
//                    // 根据删除操作的部门信息删除任务的对应信息
//                    depInfo.remove(delGrpBList.getString(i));
//                }
//                // 更新任务信息
//                objTask.put(dep,depInfo);
...
//                    for (int i = 0; i < addDep.size(); i++) {
//                        // 添加新增信息
//                        depInfo.put(addDep.getString(i),new JSONObject());
//                    }
//                    // 更新任务信息
//                    objTask.put(dep,depInfo);
//                } else {
...
//                    for (int i = 0; i < addDep.size(); i++) {
//                        // 获取任务对应的组别信息
//                        JSONObject grpBInfo = depInfo.getJSONObject(addDep.getString(i));
//                        // 判断任务组别信息为空
//                        if (null == grpBInfo) {
//                            // 添加新增操作信息
//                            depInfo.put(addDep.getString(i),new JSONObject());
